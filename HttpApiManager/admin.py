...
from HttpApiManager.models import UserInfo, ProjectInfo, ModuleInfo, TestCaseInfo, EnvInfo
...
admin.site.site_header = 'MultipleInterfaceManager运维管理系统'
admin.site.site_title = 'MultipleInterfaceManager'
