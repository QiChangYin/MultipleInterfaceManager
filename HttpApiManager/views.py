...
from HttpApiManager.models import ProjectInfo, ModuleInfo, TestCaseInfo, UserInfo, EnvInfo, TestReports, DebugTalk, \
    TestSuite
from HttpApiManager.tasks import main_hrun
from HttpApiManager.utils.common import module_info_logic, project_info_logic, case_info_logic, config_info_logic, \
...
from HttpApiManager.utils.operation import env_data_logic, del_module_data, del_project_data, del_test_data, copy_test_data, \
    del_report_data, add_suite_data, copy_suite_data, del_suite_data, edit_suite_data
from HttpApiManager.utils.pagination import get_pager_info
from HttpApiManager.utils.runner import run_by_batch, run_test_by_type
...
def test(request):
    ...
    :return:
    """
    print("SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS: {}",request.body.decode('utf-8'))
    decodestr = base64.b64decode(request.body.decode('utf-8'))
    ...
    return JsonResponse({"code": "OK", "success": {"key1":"value1","key2":"values"}})
