# Generated by Django 2.0.3 on 2018-07-02 15:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('include', models.CharField(max_length=500, null=True, verbose_name='包含config/test')),
                ('author', models.CharField(max_length=20, verbose_name='编写人员')),
                ('request', models.TextField(verbose_name='请求信息')),
                ('belong_module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HttpApiManager.ModuleInfo')),
            ],
            options={
                'verbose_name': '用例信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('belong_project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HttpApiManager.ProjectInfo')),
            ],
            options={
                'verbose_name': '用例集合',
                'db_table': 'TestSuite',
        ...
        migrations.AddField(
            ...
            name='belong_project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HttpApiManager.ProjectInfo'),
        ),
        migrations.AddField(
