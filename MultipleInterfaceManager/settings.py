"""
Django settings for MultipleInterfaceManager project.
...
ROOT_URLCONF = 'MultipleInterfaceManager.urls'
...
WSGI_APPLICATION = 'MultipleInterfaceManager.wsgi.application'
